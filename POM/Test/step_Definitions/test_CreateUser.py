...
def step_Fill_All_Fields_Form(browser):
    ...
    time.sleep(2)
    account.complete_All_Field_For_New_Account("Lukagesaa", "Cornejosa", "Lukageddd.Cornejo103@darwoft.com",
                                               "Sol de Mayo 550", "Cordoba", "5000", "Lukagessdd_Corneje", "River101",
                                               "River101")
    time.sleep(2)
